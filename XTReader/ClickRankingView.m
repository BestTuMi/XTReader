...
@interface ClickRankingView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ClickRankingView
...
//    _novelArray = [novelModel getNovelArrayWithAppKey:AppKey cat:1 ranks:1];
